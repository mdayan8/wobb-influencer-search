    ...
    >
      ...
      <div className="relative h-12 w-12 shrink-0">
        <img
          ...
          className="h-12 w-12 rounded-full object-cover ring-2 ring-slate-100 transition-shadow group-hover:ring-violet-100 dark:ring-slate-800 dark:group-hover:ring-violet-500/20"
        />
        {following && (
      ...
      <div className="min-w-0 flex-1 text-left">
        ...
        <div className="mt-0.5 flex items-center gap-1.5 text-[11px] font-medium text-slate-400 dark:text-slate-500">
      ...
      <div className="flex shrink-0 items-center gap-2">
        <button
          ...
          className={clsx(
            "flex h-9 min-w-[90px] items-center justify-center gap-1.5 rounded-xl px-3 text-xs font-semibold transition-all duration-200",
            following
        ...
        <button
          ...
          className={clsx(
            "flex h-9 min-w-[80px] items-center justify-center gap-1.5 rounded-xl px-3 text-xs font-semibold transition-all duration-200",
            inList
